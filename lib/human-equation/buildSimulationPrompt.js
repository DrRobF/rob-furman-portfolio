...
const allowedParentLanguages = new Set(['English', 'Spanish', 'Haitian Creole', 'Portuguese']);
const normalizeParentLanguage = (value) => (allowedParentLanguages.has(value) ? value : 'English');
