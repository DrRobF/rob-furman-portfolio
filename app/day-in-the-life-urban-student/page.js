    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You slide the packet aside and grab your things before anyone can ask questions.' },
      ...
      },
      {
        ...
        result: [
          { type: 'paragraph', text: 'You stop pretending you can focus on schoolwork and head for the hall instead.' },
          { type: 'paragraph', text: 'If nobody will tell you what happened, you will find a way yourself before your mind explodes.' },
        ],
        metrics: { sleep: 0, stress: -2, time: 1, care: -1 },
        nextSceneId: 'scene_hallway_internal_reflection',
      },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You turn against the traffic and start moving toward her classroom.' },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You fold your arms on the desk and drop your head before your body gives out on its own.' },
          { type: 'paragraph', text: 'The teacher’s voice turns into background noise, and for a few minutes your brain finally stops racing.' },
        ],
      ...
      },
      {
        ...
        result: [
          { type: 'paragraph', text: 'You force your eyes toward the front and catch pieces of the story one line at a time.' },
          { type: 'paragraph', text: 'The words keep slipping away when thoughts about home cut back in, but you keep trying not to drift off.' },
        ],
        metrics: { sleep: -1, stress: 1, time: 0, care: 1 },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You keep your head down through the rest of class and wait for the bell like it might save you.' },
          { type: 'paragraph', text: 'When it rings, you move fast toward gym, telling yourself to survive one more period.' },
        ],
        metrics: { sleep: 0, stress: -2, time: 1, care: -1 },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'The security guard tightens his grip and pushes you through the hallway before you can say another word.' },
          { type: 'paragraph', text: 'Kids stare as you pass, and the knot in your chest gets hotter all the way back to the office.' },
        ],
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You drop into the chair and keep replaying what everyone said in the hallway.' },
          { type: 'paragraph', text: 'Minutes drag by while adults talk around you, like you are the problem but not a person in the room.' },
        ],
        metrics: { sleep: 0, stress: -2, time: -1, care: -2 },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'The decision is made without hearing your side, and you are marched down to ISS.' },
          { type: 'paragraph', text: 'You feel yourself shut down as the door closes behind you.' },
        ],
        metrics: { sleep: 0, stress: -2, time: -1, care: -2 },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You wrench free and sprint before anyone can pin you down again.' },
          { type: 'paragraph', text: 'By the time you hit the sidewalk, your lungs burn and your hands are still shaking from rage.' },
        ],
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'The sidewalk tilts and your legs stop listening.' },
          { type: 'paragraph', text: 'You hear distant voices for a second, then everything drops into black.' },
        ],
        metrics: { sleep: 0, stress: -4, time: -2, care: -3 },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You pull the blanket up and stare at the ceiling, too exhausted to fight anything else tonight.' },
          { type: 'paragraph', text: 'When the room finally quiets, the day replays in your head and leaves you with heavy questions.' },
        ],
      ...
      },
      {
        ...
        result: [
          { type: 'paragraph', text: 'You sit up with that same urge to run from everything that happened.' },
    ...
    choices: [
      {
        ...
        result: [
          { type: 'paragraph', text: 'You close out the reflection carrying the full chain of what Adam endured.' },
...
export default function DayInTheLifeUrbanStudentPage() {
  ...
  const canContinue = Boolean(selectedChoice) && (!hasMicroReflection || Boolean(selectedMicroReflectionAnswer));
  ...
  const dayProgressIndex = Math.min(
    dayProgressLabels.length - 1,
    Math.floor(((scene.sceneNumber ?? 1) - 1) / Math.max(1, Math.ceil((scene.totalScenes ?? 1) / dayProgressLabels.length)))
  );
  ...
  return (
    <main className="urban-student-page">
      ...
      <style jsx>{`
        ...
        .metrics-stack { display: grid; gap: 14px; background: linear-gradient(180deg, #f7faff 0%, #f1f5fb 100%); border: 1px solid #c8d4e3; border-radius: 20px; padding: 20px; }
        .metrics-side-panel { position: sticky; top: 16px; }
        .metric-subtitle { margin: -6px 0 2px; color: #334155; font-size: 0.96rem; }
        .metric-context-row { display: flex; flex-wrap: wrap; gap: 10px; margin: 2px 0 0; }
        .overall-state, .day-progress { margin: 0; font-size: 0.8rem; color: #334155; border: 1px solid #d4deea; border-radius: 999px; padding: 7px 12px; background: #ffffff; }
        ...
        @media (max-width: 1024px) {
          .experience-layout { grid-template-columns: minmax(0, 1fr); }
          .metrics-side-panel { position: static; }
          .scene-card { max-width: none; }
        }
