...
No one asks.` },
  ...
  },
  {
    ...
    question: 'Continue',
    choices: [{ id: 'to_reading', label: 'Go to 3rd Period Reading Class', resultTitle: 'You move to third period.', result: [{ type: 'paragraph', text: 'You move toward third period.' }], metrics: { sleep: 0, stress: 0, time: 0, care: 0 }, nextSceneId: 'scene_third_period_reading_class' }],
  },
  {
