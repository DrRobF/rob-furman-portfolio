...
const licks = [
  {
    title: 'Porch Light Turnaround', key: 'A', style: 'Blues', difficulty: 'Beginner', tempo: '78 bpm', chord: 'A7', targetNotes: ['C# (3rd)', 'E (5th)', 'G (b7)'],
    tab: `e|------------------------|\nB|------5-8b9r8-5---------|\nG|--5/6-----------6-5-----|\nD|--------------------7---|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Midnight Shuffle Answer', key: 'E', style: 'Blues', difficulty: 'Beginner', tempo: '86 bpm', chord: 'E7', targetNotes: ['G# (3rd)', 'D (b7)', 'E (root)'],
    tab: `e|----------------0-------|\nB|----------3-0-----------|\nG|------1/2-----2-0h1-----|\nD|--2-2----------------2--|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Blue Door Rake', key: 'G', style: 'Blues', difficulty: 'Intermediate', tempo: '72 bpm', chord: 'G7', targetNotes: ['B (3rd)', 'F (b7)', 'G (root)'],
    tab: `e|------------------------|\nB|--6r5-3-----------------|\nG|--------5-3h4-----------|\nD|--------------5-3-------|\nA|------------------5-----|\nE|------------------------|`,
  ...
  {
    title: 'Garage Door Climb', key: 'E', style: 'Rock', difficulty: 'Beginner', tempo: '104 bpm', chord: 'E5', targetNotes: ['E (root)', 'G (b3)', 'B (5th)'],
    tab: `e|------------------------|\nB|------------------------|\nG|----------0-2-0---------|\nD|------0h2-------2-0-----|\nA|--0h2---------------2---|\nE|------------------------|`,
  ...
  {
    title: 'Amp Glow Hook', key: 'D', style: 'Rock', difficulty: 'Intermediate', tempo: '118 bpm', chord: 'D5', targetNotes: ['D (root)', 'F (b3)', 'A (5th)'],
    tab: `e|------------------------|\nB|--10-8------------------|\nG|-------9-7---7----------|\nD|-----------9---9-7------|\nA|-------------------10---|\nE|------------------------|`,
  ...
  {
    title: 'Redline Bend', key: 'A', style: 'Rock', difficulty: 'Advanced', tempo: '128 bpm', chord: 'A5', targetNotes: ['C (b3)', 'D (4th)', 'E (5th)'],
    tab: `e|------------------------|\nB|--8b10-8-5--------------|\nG|-----------7p5---5------|\nD|---------------7---7-5--|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Sunday Morning Thirds', key: 'C', style: 'Soulful Major', difficulty: 'Beginner', tempo: '76 bpm', chord: 'Cmaj7', targetNotes: ['E (3rd)', 'G (5th)', 'B (7th)'],
    tab: `e|----------7-8-----------|\nB|------8-------8---------|\nG|--7/9---9-------9-7-----|\nD|--------------------10--|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Window Seat Melody', key: 'G', style: 'Soulful Major', difficulty: 'Intermediate', tempo: '82 bpm', chord: 'G6', targetNotes: ['B (3rd)', 'E (6th)', 'G (root)'],
    tab: `e|------------------------|\nB|--8-10-8----------------|\nG|---------9-7h9-7--------|\nD|-----------------9-7-5--|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Gold Thread Resolve', key: 'F', style: 'Soulful Major', difficulty: 'Advanced', tempo: '70 bpm', chord: 'Fmaj9', targetNotes: ['A (3rd)', 'G (9th)', 'C (5th)'],
    tab: `e|--8-10-12-10-8----------|\nB|--------------10-8------|\nG|-------------------10-9-|\nD|------------------------|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Fence Post Pickup', key: 'G', style: 'Country-ish', difficulty: 'Beginner', tempo: '96 bpm', chord: 'G', targetNotes: ['B (3rd)', 'D (5th)', 'G (root)'],
    tab: `e|----------3-------------|\nB|------3h5---5p3---------|\nG|--2/4-----------4-2-0---|\nD|------------------------|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Dusty Double-Stop', key: 'D', style: 'Country-ish', difficulty: 'Intermediate', tempo: '108 bpm', chord: 'D', targetNotes: ['F# (3rd)', 'A (5th)', 'D (root)'],
    tab: `e|--5-5---3-2-------------|\nB|--7-7---5-3-------------|\nG|--------------4-2-------|\nD|------------------4-0---|\nA|------------------------|\nE|------------------------|`,
  ...
  {
    title: 'Pickup Truck Chime', key: 'A', style: 'Country-ish', difficulty: 'Advanced', tempo: '116 bpm', chord: 'A', targetNotes: ['C# (3rd)', 'E (5th)', 'A (root)'],
    tab: `e|--9-5-------------------|\nB|------7-5---------------|\nG|----------6-4h6-4-------|\nD|------------------7-4---|\nA|----------------------7-|\nE|------------------------|`,
...
export function LickLibrary() {
  const [filters, setFilters] = useState({ style: allOption, difficulty: allOption, key: allOption });
  ...
  const move = (direction) => setCurrentIndex((index) => (filteredLicks.length + activeIndex + direction) % filteredLicks.length);

  return (
    <>
      <section className="lick-library-controls" aria-label="Lick library controls">
        {[['style', 'Style filter'], ['difficulty', 'Difficulty filter'], ['key', 'Key filter']].map(([name, label]) => (
      ...
      {lick ? <article className="lick-practice-card" aria-live="polite">
        ...
        <header className="lick-practice-header"><div><h2>{lick.title}</h2><p className="lick-subtitle">{lick.style} · {lick.key} · {lick.difficulty} · {lick.tempo}</p></div><div className="lick-chord">Works over <strong>{lick.chord}</strong></div></header>
        <pre className="lick-tab" aria-label={`${lick.title} guitar tablature`}>{lick.tab}</pre>
        <div className="lick-action-row"><button type="button" onClick={() => move(-1)}>Previous Lick</button><button type="button" onClick={() => move(1)}>Next Lick</button><button className={loopPractice ? 'active' : ''} type="button" onClick={() => setLoopPractice((value) => !value)}>Loop Practice {loopPractice ? 'On' : 'Off'}</button></div>
        <p className="lick-audio-note">Audio coming soon — practice from the tab for now.</p>
        <div className="lick-detail-grid"><section><h3>Target notes</h3><ul>{lick.targetNotes.map((note) => <li key={note}>{note}</li>)}</ul></section><section><h3>Why it works</h3><p>{lick.why}</p></section><section className="lick-steps"><h3>Practice steps</h3><ol>{lick.steps.map((step) => <li key={step}>{step}</li>)}</ol></section></div>
