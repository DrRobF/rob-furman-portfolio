...
export default function HumanEquationDashboardPage() {
  ...
  return <section className="section help-suite-page help-suite-internal help-page-dark"><div className="container"><div className='help-suite-nav-wrap'><HumanEquationNav /></div>
    ...
    <main className="hes-main-content">
      <HelpJourneyNav currentStep='dashboard' explanation='Your dashboard is your leadership evidence home base. Diagnostics, learning, and simulations all connect back here over time.' primaryAction={{ label: 'Continue Your H.E.L.P. Journey', href: '/human-equation-suite/course' }} secondaryAction={{ label: 'Practice Under Pressure', href: '/simulation-overview' }} />
