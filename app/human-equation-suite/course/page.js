...
export default function CourseLanding() {
  ...
  return <section className='section help-suite-page help-suite-internal help-page-dark'><div className='container'><div className='help-suite-nav-wrap'><HumanEquationNav /></div><HelpSuiteShell currentArea="course">
