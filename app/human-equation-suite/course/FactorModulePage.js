...
export default function FactorModulePage({ module }) {
  ...
  return <main className="section help-suite-page"><div className="container"><div className='help-suite-nav-wrap'><HumanEquationNav /></div>
    <section className='hes-awareness-hero hes-awareness-hero-premium help-suite-hero top-space-sm'>
